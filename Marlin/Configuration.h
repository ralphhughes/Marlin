...
#define STRING_CONFIG_H_AUTHOR "(Ralph Hughes, 2020)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // From original P802MA firmware:
  // #define  DEFAULT_Kp 		22.2
  // #define  DEFAULT_Ki 		1.08
  // #define  DEFAULT_Kd 		114

  // From my P802MA after running PID_AUTOTUNE
  #define  DEFAULT_Kp 		19.62
  #define  DEFAULT_Ki 		1.08
  #define  DEFAULT_Kd 		89.19
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // My stock P802MA  aluminium bed from pid autotune
  #define DEFAULT_bedKp 255.38
  #define DEFAULT_bedKi 36.67
  #define DEFAULT_bedKd 444.59
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 400, 79.5}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // For sensor in front and to the left of nozzle: 
  #define LEFT_PROBE_BED_POSITION (MIN_PROBE_EDGE)	// 10
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE  + X_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE) // 220-18-10=192
  #define FRONT_PROBE_BED_POSITION (MIN_PROBE_EDGE)	// 10
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE + Y_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE) // 220-44-10=166
